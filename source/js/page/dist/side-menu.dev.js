...
function onSideMenuCollapse() {
  if (isSideMenuCollapse) {
    $(".side-menu-container").removeClass("animate__fadeIn").addClass("animate__fadeOut");
    $(".side-menu-container .menu").removeClass("animate__slideInLeft").addClass("animate__slideOutLeft");
    setTimeout(function () {
      $(".side-menu-container").css("visibility", "hidden");
    }, 500);
  } else {
    $(".side-menu-container").css("visibility", "visible").removeClass("animate__fadeOut").addClass("animate__fadeIn");
    $(".side-menu-container .menu").removeClass("animate__slideOutLeft").addClass("animate__slideInLeft");
  }
