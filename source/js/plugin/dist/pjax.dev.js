...
(function (f) {
  ...
  return function () {
    ...
    1: [function (require, module, exports) {
      ...
      Pjax.isSupported = require("./lib/is-supported"); // arguably could do `if( require("./lib/is-supported")()) {` but that might be a little to simple
    ...
    6: [function (require, module, exports) {
      ...
      var evalScript = require("./eval-script"); // Finds and executes scripts (used for newly added elements)
